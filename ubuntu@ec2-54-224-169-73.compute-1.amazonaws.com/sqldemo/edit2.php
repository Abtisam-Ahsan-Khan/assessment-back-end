    ...
    <head>
        ...
        <body>
            ...
            <form action="edit3.php" method="GET">
                ...
                <input id="first-name-input" name="employee_first_name" type="text" value="<?php echo($record['first_name']); ?>" />
                <br />
                <label for="last-name-input">Employee Last Name:</label>
                <input id="last-name-input" name="employee_last_name" type="text" value="<?php echo($record['last_name']); ?>" />
<br />
