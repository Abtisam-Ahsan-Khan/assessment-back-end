...
<body>
    <div class="container">
        ...
        // Query to fetch all data from the Pupil table
        ...
        if ($result->num_rows > 0) {
            ...
            // Fetch each row of data from the result set and output it as a table row
        ...
        // Query to fetch all data from the ParentGuardian table
        echo "<h2>Parents</h2>";
